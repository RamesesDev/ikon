...
<tr>
	...
	<td><input class="form-input" type="text" r:context="${context}" r:name="${objPrefix}${name}" r:caption="${caption}"
		...
		<c:if test="${! empty visibleWhen}"> r:visibleWhen="${visibleWhen}" </c:if>/></td> 
</tr>
