...
<t:content title="Room Schedules">
			...
			new function() {
				...
				this.listModel = {
					fetchList: function(o) {
						...
						return svc.getRoomAvailability(o);	
					}
				}	
	...
	<jsp:body>
		<ui:context name="room_schedule_list">
			...
			<ui:panel cols="2" width="100%">
				<ui:section width="70%">
					...
					<ui:grid model="listModel" width="100%">
						<ui:col caption="Room" width="80%">#{item.roomno}</ui:col>
						<ui:col><a href="#room_schedule:info?objid=#{item.objid}">View Schedule</a></ui:col>
					</ui:grid>
				</ui:section>
				<ui:section style="padding-left:10px;padding-top:10px;">
					<ui:panel style="border:1px solid lightgrey;padding:4px;" width="100%">
						...
						<ui:section>
							<select r:context="${context}" r:name="orgunit" r:items="academicOrgUnits" r:itemLabel="code" r:allowNull="true" r:emptyText="All"></select>
						</ui:section>
